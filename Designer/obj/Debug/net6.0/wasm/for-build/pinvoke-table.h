...
void gr_direct_context_flush_image (int,int);
void gr_direct_context_flush_surface (int,int);
...
int gr_recording_context_is_abandoned (int);
int gr_recording_context_max_render_target_size (int);
int gr_recording_context_max_texture_size (int);
...
int sk_bitmap_make_shader (int,int,int,int,int);
int sk_bitmap_new ();
...
int sk_blender_new_arithmetic (float,float,float,float,int);
int sk_blender_new_mode (int);
void sk_blender_ref (int);
void sk_blender_unref (int);
...
void sk_canvas_draw_atlas (int,int,int,int,int,int,int,int,int,int);
...
void sk_canvas_draw_image (int,int,float,float,int,int);
void sk_canvas_draw_image_lattice (int,int,int,int,int,int);
void sk_canvas_draw_image_nine (int,int,int,int,int,int);
void sk_canvas_draw_image_rect (int,int,int,int,int,int);
...
void sk_canvas_get_matrix (int,int);
...
int sk_canvas_new_from_raster (int,int,int,int);
...
int sk_compatpaint_get_filter_quality (int);
int sk_compatpaint_get_font (int);
int sk_compatpaint_get_lcd_render_text (int);
...
void sk_compatpaint_set_filter_quality (int,int);
void sk_compatpaint_set_is_antialias (int,int);
void sk_compatpaint_set_lcd_render_text (int,int);
...
int sk_drawable_approximate_bytes_used (int);
...
int sk_image_make_raw_shader (int,int,int,int,int);
int sk_image_make_shader (int,int,int,int,int);
int sk_image_make_subset (int,int,int);
int sk_image_make_subset_raster (int,int);
int sk_image_make_texture_image (int,int,int,int);
int sk_image_make_with_filter (int,int,int,int,int,int,int);
int sk_image_make_with_filter_raster (int,int,int,int,int,int);
...
int sk_image_new_from_picture (int,int,int,int,int,int,int);
...
int sk_imagefilter_new_blend (int,int,int,int);
int sk_imagefilter_new_blender (int,int,int,int);
...
int sk_imagefilter_new_image (int,int,int,int);
int sk_imagefilter_new_image_simple (int,int);
int sk_imagefilter_new_magnifier (int,float,float,int,int,int);
int sk_imagefilter_new_matrix_convolution (int,int,float,float,int,int,int,int,int);
int sk_imagefilter_new_matrix_transform (int,int,int);
int sk_imagefilter_new_merge (int,int,int);
int sk_imagefilter_new_merge_simple (int,int,int);
int sk_imagefilter_new_offset (float,float,int,int);
int sk_imagefilter_new_picture (int);
int sk_imagefilter_new_picture_with_rect (int,int);
...
int sk_imagefilter_new_shader (int,int,int);
...
int sk_paint_get_fill_path (int,int,int,int,int);
...
void sk_paint_set_blender (int,int);
...
int sk_picture_approximate_bytes_used (int);
int sk_picture_approximate_op_count (int,int);
...
int sk_picture_make_shader (int,int,int,int,int,int);
void sk_picture_playback (int,int);
int sk_picture_recorder_begin_recording (int,int);
int sk_picture_recorder_begin_recording_with_bbh_factory (int,int,int);
...
int sk_pixmap_compute_is_opaque (int);
void sk_pixmap_destructor (int);
int sk_pixmap_erase_color (int,int,int);
int sk_pixmap_erase_color4f (int,int,int);
int sk_pixmap_extract_subset (int,int,int);
int sk_pixmap_get_colorspace (int);
void sk_pixmap_get_info (int,int);
float sk_pixmap_get_pixel_alphaf (int,int,int);
int sk_pixmap_get_pixel_color (int,int,int);
void sk_pixmap_get_pixel_color4f (int,int,int,int);
int sk_pixmap_get_row_bytes (int);
int sk_pixmap_get_writable_addr (int);
int sk_pixmap_get_writeable_addr_with_xy (int,int,int);
int sk_pixmap_new ();
...
void sk_pixmap_set_colorspace (int,int);
...
void sk_rtree_factory_delete (int);
int sk_rtree_factory_new ();
void sk_runtimeeffect_get_child_from_index (int,int,int);
void sk_runtimeeffect_get_child_from_name (int,int,int,int);
void sk_runtimeeffect_get_child_name (int,int,int);
int sk_runtimeeffect_get_children_size (int);
int sk_runtimeeffect_get_uniform_byte_size (int);
void sk_runtimeeffect_get_uniform_from_index (int,int,int);
void sk_runtimeeffect_get_uniform_from_name (int,int,int,int);
void sk_runtimeeffect_get_uniform_name (int,int,int);
int sk_runtimeeffect_get_uniforms_size (int);
int sk_runtimeeffect_make_blender (int,int,int,int);
int sk_runtimeeffect_make_color_filter (int,int,int,int);
int sk_runtimeeffect_make_for_blender (int,int);
int sk_runtimeeffect_make_for_color_filter (int,int);
int sk_runtimeeffect_make_for_shader (int,int);
int sk_runtimeeffect_make_shader (int,int,int,int,int);
void sk_runtimeeffect_unref (int);
int sk_shader_new_blend (int,int,int);
int sk_shader_new_blender (int,int,int);
...
void sk_textblob_builder_alloc_run_rsxform (int,int,int,int,int);
...
void sk_textblob_builder_alloc_run_text_rsxform (int,int,int,int,int,int);
...
InterpFtnDesc wasm_native_to_interp_ftndescs[55];
typedef void  (*WasmInterpEntrySig_0) (int*,int*);
void wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_DestroyProxyImplementation (int arg0) { 
...
void wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_DestroyProxyImplementationForMulti (int arg0) { 
((WasmInterpEntrySig_1)wasm_native_to_interp_ftndescs [1].func) (&arg0, wasm_native_to_interp_ftndescs [1].arg);
}
typedef void  (*WasmInterpEntrySig_2) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetFontExtentsProxyImplementation (int arg0,int arg1,int arg2,int arg3) { 
int res;
((WasmInterpEntrySig_2)wasm_native_to_interp_ftndescs [2].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [2].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_3) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphAdvanceProxyImplementation (int arg0,int arg1,int arg2,int arg3) { 
int res;
((WasmInterpEntrySig_3)wasm_native_to_interp_ftndescs [3].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [3].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_4) (int*,int*,int*,int*,int*,int*,int*,int*,int*);
void wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphAdvancesProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,int arg5,int arg6,int arg7) { 
((WasmInterpEntrySig_4)wasm_native_to_interp_ftndescs [4].func) (&arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, wasm_native_to_interp_ftndescs [4].arg);
}
typedef void  (*WasmInterpEntrySig_5) (int*,int*,int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphContourPointProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,int arg5,int arg6) { 
int res;
((WasmInterpEntrySig_5)wasm_native_to_interp_ftndescs [5].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, wasm_native_to_interp_ftndescs [5].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_6) (int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphExtentsProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4) { 
int res;
...
typedef void  (*WasmInterpEntrySig_7) (int*,int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphFromNameProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,int arg5) { 
int res;
((WasmInterpEntrySig_7)wasm_native_to_interp_ftndescs [7].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, wasm_native_to_interp_ftndescs [7].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_8) (int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphKerningProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4) { 
int res;
((WasmInterpEntrySig_8)wasm_native_to_interp_ftndescs [8].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [8].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_9) (int*,int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphNameProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,int arg5) { 
int res;
...
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphOriginProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,int arg5) { 
int res;
((WasmInterpEntrySig_10)wasm_native_to_interp_ftndescs [10].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, wasm_native_to_interp_ftndescs [10].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_11) (int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetNominalGlyphProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4) { 
int res;
...
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetNominalGlyphsProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,int arg5,int arg6,int arg7) { 
int res;
((WasmInterpEntrySig_12)wasm_native_to_interp_ftndescs [12].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, wasm_native_to_interp_ftndescs [12].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_13) (int*,int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetVariationGlyphProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,int arg5) { 
int res;
...
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_ReferenceTableProxyImplementation (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_14)wasm_native_to_interp_ftndescs [14].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [14].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_15) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeCombiningClassProxyImplementation (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_15)wasm_native_to_interp_ftndescs [15].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [15].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_16) (int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeComposeProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4) { 
int res;
((WasmInterpEntrySig_16)wasm_native_to_interp_ftndescs [16].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [16].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_17) (int*,int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeDecomposeProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4) { 
int res;
((WasmInterpEntrySig_17)wasm_native_to_interp_ftndescs [17].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [17].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_18) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeGeneralCategoryProxyImplementation (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_18)wasm_native_to_interp_ftndescs [18].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [18].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_19) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeMirroringProxyImplementation (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_19)wasm_native_to_interp_ftndescs [19].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [19].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_20) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeScriptProxyImplementation (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_20)wasm_native_to_interp_ftndescs [20].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [20].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_21) (int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_GRGlGetProcProxyImplementation (int arg0,int arg1) { 
int res;
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_GRVkGetProcProxyImplementation (int arg0,int arg1,int arg2,int arg3) { 
int res;
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKBitmapReleaseProxyImplementation (int arg0,int arg1) { 
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKDataReleaseProxyImplementation (int arg0,int arg1) { 
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKGlyphPathProxyImplementation (int arg0,int arg1,int arg2) { 
((WasmInterpEntrySig_25)wasm_native_to_interp_ftndescs [25].func) (&arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [25].arg);
}
typedef void  (*WasmInterpEntrySig_26) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageRasterReleaseProxyImplementation (int arg0,int arg1) { 
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageRasterReleaseProxyImplementationForCoTaskMem (int arg0,int arg1) { 
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageTextureReleaseProxyImplementation (int arg0) { 
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableApproximateBytesUsedProxyImplementation (int arg0,int arg1) { 
int res;
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableDestroyProxyImplementation (int arg0,int arg1) { 
((WasmInterpEntrySig_30)wasm_native_to_interp_ftndescs [30].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [30].arg);
}
typedef void  (*WasmInterpEntrySig_31) (int*,int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableDrawProxyImplementation (int arg0,int arg1,int arg2) { 
((WasmInterpEntrySig_31)wasm_native_to_interp_ftndescs [31].func) (&arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [31].arg);
}
typedef void  (*WasmInterpEntrySig_32) (int*,int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableGetBoundsProxyImplementation (int arg0,int arg1,int arg2) { 
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableMakePictureSnapshotProxyImplementation (int arg0,int arg1) { 
int res;
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamDestroyProxyImplementation (int arg0,int arg1) { 
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamDuplicateProxyImplementation (int arg0,int arg1) { 
int res;
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamForkProxyImplementation (int arg0,int arg1) { 
int res;
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamGetLengthProxyImplementation (int arg0,int arg1) { 
int res;
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamGetPositionProxyImplementation (int arg0,int arg1) { 
int res;
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamHasLengthProxyImplementation (int arg0,int arg1) { 
int res;
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamHasPositionProxyImplementation (int arg0,int arg1) { 
int res;
...
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamIsAtEndProxyImplementation (int arg0,int arg1) { 
int res;
((WasmInterpEntrySig_41)wasm_native_to_interp_ftndescs [41].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [41].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_42) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamMoveProxyImplementation (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_42)wasm_native_to_interp_ftndescs [42].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [42].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_43) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamPeekProxyImplementation (int arg0,int arg1,int arg2,int arg3) { 
int res;
...
typedef void  (*WasmInterpEntrySig_44) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamReadProxyImplementation (int arg0,int arg1,int arg2,int arg3) { 
int res;
((WasmInterpEntrySig_44)wasm_native_to_interp_ftndescs [44].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [44].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_45) (int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamRewindProxyImplementation (int arg0,int arg1) { 
int res;
((WasmInterpEntrySig_45)wasm_native_to_interp_ftndescs [45].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [45].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_46) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamSeekProxyImplementation (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_46)wasm_native_to_interp_ftndescs [46].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [46].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_47) (int*,int*,int*,int*,int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedTraceMemoryDumpDumpNumericValueProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4,uint64_t arg5) { 
((WasmInterpEntrySig_47)wasm_native_to_interp_ftndescs [47].func) (&arg0, &arg1, &arg2, &arg3, &arg4, &arg5, wasm_native_to_interp_ftndescs [47].arg);
}
typedef void  (*WasmInterpEntrySig_48) (int*,int*,int*,int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedTraceMemoryDumpDumpStringValueProxyImplementation (int arg0,int arg1,int arg2,int arg3,int arg4) { 
((WasmInterpEntrySig_48)wasm_native_to_interp_ftndescs [48].func) (&arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [48].arg);
}
typedef void  (*WasmInterpEntrySig_49) (int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamBytesWrittenProxyImplementation (int arg0,int arg1) { 
int res;
...
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamDestroyProxyImplementation (int arg0,int arg1) { 
((WasmInterpEntrySig_50)wasm_native_to_interp_ftndescs [50].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [50].arg);
}
typedef void  (*WasmInterpEntrySig_51) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamFlushProxyImplementation (int arg0,int arg1) { 
((WasmInterpEntrySig_51)wasm_native_to_interp_ftndescs [51].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [51].arg);
}
typedef void  (*WasmInterpEntrySig_52) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamWriteProxyImplementation (int arg0,int arg1,int arg2,int arg3) { 
int res;
((WasmInterpEntrySig_52)wasm_native_to_interp_ftndescs [52].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [52].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_53) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKSurfaceRasterReleaseProxyImplementation (int arg0,int arg1) { 
...
((WasmInterpEntrySig_54)wasm_native_to_interp_ftndescs [54].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [54].arg);
}
static void *wasm_native_to_interp_funcs[] = { wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_DestroyProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_DestroyProxyImplementationForMulti,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetFontExtentsProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphAdvanceProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphAdvancesProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphContourPointProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphExtentsProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphFromNameProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphKerningProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphNameProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetGlyphOriginProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetNominalGlyphProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetNominalGlyphsProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_FontGetVariationGlyphProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_ReferenceTableProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeCombiningClassProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeComposeProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeDecomposeProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeGeneralCategoryProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeMirroringProxyImplementation,wasm_native_to_interp_HarfBuzzSharp_DelegateProxies_UnicodeScriptProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_GRGlGetProcProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_GRVkGetProcProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKBitmapReleaseProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKDataReleaseProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKGlyphPathProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageRasterReleaseProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageRasterReleaseProxyImplementationForCoTaskMem,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageTextureReleaseProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableApproximateBytesUsedProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableDestroyProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableDrawProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableGetBoundsProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedDrawableMakePictureSnapshotProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamDestroyProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamDuplicateProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamForkProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamGetLengthProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamGetPositionProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamHasLengthProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamHasPositionProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamIsAtEndProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamMoveProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamPeekProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamReadProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamRewindProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedStreamSeekProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedTraceMemoryDumpDumpNumericValueProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedTraceMemoryDumpDumpStringValueProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamBytesWrittenProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamDestroyProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamFlushProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKManagedWStreamWriteProxyImplementation,wasm_native_to_interp_SkiaSharp_DelegateProxies_SKSurfaceRasterReleaseProxyImplementation,wasm_native_to_interp_System_Private_CoreLib_CalendarData_EnumCalendarInfoCallback,};
static const char *wasm_native_to_interp_map[] = { "HarfBuzzSharp_DelegateProxies_DestroyProxyImplementation",
"HarfBuzzSharp_DelegateProxies_DestroyProxyImplementationForMulti",
"HarfBuzzSharp_DelegateProxies_FontGetFontExtentsProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphAdvanceProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphAdvancesProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphContourPointProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphExtentsProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphFromNameProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphKerningProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphNameProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetGlyphOriginProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetNominalGlyphProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetNominalGlyphsProxyImplementation",
"HarfBuzzSharp_DelegateProxies_FontGetVariationGlyphProxyImplementation",
"HarfBuzzSharp_DelegateProxies_ReferenceTableProxyImplementation",
"HarfBuzzSharp_DelegateProxies_UnicodeCombiningClassProxyImplementation",
"HarfBuzzSharp_DelegateProxies_UnicodeComposeProxyImplementation",
"HarfBuzzSharp_DelegateProxies_UnicodeDecomposeProxyImplementation",
"HarfBuzzSharp_DelegateProxies_UnicodeGeneralCategoryProxyImplementation",
"HarfBuzzSharp_DelegateProxies_UnicodeMirroringProxyImplementation",
"HarfBuzzSharp_DelegateProxies_UnicodeScriptProxyImplementation",
"SkiaSharp_DelegateProxies_GRGlGetProcProxyImplementation",
"SkiaSharp_DelegateProxies_GRVkGetProcProxyImplementation",
"SkiaSharp_DelegateProxies_SKBitmapReleaseProxyImplementation",
"SkiaSharp_DelegateProxies_SKDataReleaseProxyImplementation",
"SkiaSharp_DelegateProxies_SKGlyphPathProxyImplementation",
"SkiaSharp_DelegateProxies_SKImageRasterReleaseProxyImplementation",
"SkiaSharp_DelegateProxies_SKImageRasterReleaseProxyImplementationForCoTaskMem",
"SkiaSharp_DelegateProxies_SKImageTextureReleaseProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedDrawableApproximateBytesUsedProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedDrawableDestroyProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedDrawableDrawProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedDrawableGetBoundsProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedDrawableMakePictureSnapshotProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamDestroyProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamDuplicateProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamForkProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamGetLengthProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamGetPositionProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamHasLengthProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamHasPositionProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamIsAtEndProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamMoveProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamPeekProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamReadProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamRewindProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedStreamSeekProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedTraceMemoryDumpDumpNumericValueProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedTraceMemoryDumpDumpStringValueProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedWStreamBytesWrittenProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedWStreamDestroyProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedWStreamFlushProxyImplementation",
"SkiaSharp_DelegateProxies_SKManagedWStreamWriteProxyImplementation",
"SkiaSharp_DelegateProxies_SKSurfaceRasterReleaseProxyImplementation",
